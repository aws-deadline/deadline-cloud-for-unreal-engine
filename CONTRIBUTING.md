...
4. Ensure you can still run a test render successfully when making significant code or data changes.  See [this guide](https://docs.aws.amazon.com/deadline-cloud/latest/userguide/epic-unreal-engine.html#unreal-engine-test-render)
