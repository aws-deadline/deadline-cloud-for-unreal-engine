:: 0. Get url from env
set DEADLINE_CLOUD_FOR_UNREAL_GIT_URL=https://github.com/casillias2/deadline-cloud-for-unreal-engine.git
set DEADLINE_CLOUD_FOR_UNREAL_GIT_BRANCH=release

set DEADLINE_CLOUD_GIT_URL=https://github.com/casillias2/deadline-cloud.git
...
echo f | xcopy /s /i deadline-cloud-for-unreal\src\deadline\unreal_submitter ..\Content\Python\libraries\deadline\unreal_submitter\
