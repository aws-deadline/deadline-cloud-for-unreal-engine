...
ADAPTOR_BUNDLE_DIRECTORY = os.getenv("ADAPTOR_BUNDLE_DIRECTORY", "")

INSTALL_MARKETPLACE_PLUGINS_ENVIRONMENT_TEMPLATE_DEFAULT_PATH = (
    "install_marketplace_plugins_environment.yml"
)
...
ADAPTOR_SETUP_ENVIRONMENT_TEMPLATE_DEFAULT_PATH = "adaptor_setup_environment.yml"
