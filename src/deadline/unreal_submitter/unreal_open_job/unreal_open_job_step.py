...
class UnrealOpenJobStep(UnrealOpenJobEntity):
    ...
    def _build_step_parameter_definition_list(self) -> list:
        ...
        for yaml_p in yaml_params:
            ...
            if override_param and override_param.range:
    ...
    def _substitute_chunk_parameter_values(self, yaml_param: dict) -> dict:
        ...
        The OpenJD model requires rangeConstraint to be a literal value (CONTIGUOUS or
        NONCONTIGUOUS), not a template expression. This method resolves the template
        expression to the actual value from job parameters.
...
class RenderUnrealOpenJobStep(UnrealOpenJobStep):
    ...
    def _build_template(self) -> StepTemplate:
        ...
        # Skip chunk ID calculation for dynamic chunking templates
